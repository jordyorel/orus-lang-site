...
var _initWebVM = Module["_initWebVM"] = makeInvalidEarlyAccess("_initWebVM");

var _runSource = Module["_runSource"] = makeInvalidEarlyAccess("_runSource");

var _freeWebVM = Module["_freeWebVM"] = makeInvalidEarlyAccess("_freeWebVM");

var _getVersion = Module["_getVersion"] = makeInvalidEarlyAccess("_getVersion");

var _setInputCallback = Module["_setInputCallback"] = makeInvalidEarlyAccess("_setInputCallback");

var _setOutputCallback = Module["_setOutputCallback"] = makeInvalidEarlyAccess("_setOutputCallback");

var _registerWebBuiltins = Module["_registerWebBuiltins"] = makeInvalidEarlyAccess("_registerWebBuiltins");

var _getLastError = Module["_getLastError"] = makeInvalidEarlyAccess("_getLastError");

var _clearLastError = Module["_clearLastError"] = makeInvalidEarlyAccess("_clearLastError");

var _isVMReady = Module["_isVMReady"] = makeInvalidEarlyAccess("_isVMReady");

var _resetVMState = Module["_resetVMState"] = makeInvalidEarlyAccess("_resetVMState");

var _getVMStackSize = Module["_getVMStackSize"] = makeInvalidEarlyAccess("_getVMStackSize");

var _getVMFrameCount = Module["_getVMFrameCount"] = makeInvalidEarlyAccess("_getVMFrameCount");

var _getVMModuleCount = Module["_getVMModuleCount"] = makeInvalidEarlyAccess("_getVMModuleCount");
...
function assignWasmExports(wasmExports) {
  ...
  Module["_initWebVM"] = _initWebVM = createExportWrapper("initWebVM", 0);
  Module["_runSource"] = _runSource = createExportWrapper("runSource", 1);
  Module["_freeWebVM"] = _freeWebVM = createExportWrapper("freeWebVM", 0);
  Module["_getVersion"] = _getVersion = createExportWrapper("getVersion", 0);
  Module["_setInputCallback"] = _setInputCallback = createExportWrapper("setInputCallback", 1);
  Module["_setOutputCallback"] = _setOutputCallback = createExportWrapper("setOutputCallback", 1);
  Module["_registerWebBuiltins"] = _registerWebBuiltins = createExportWrapper("registerWebBuiltins", 0);
  Module["_getLastError"] = _getLastError = createExportWrapper("getLastError", 0);
  Module["_clearLastError"] = _clearLastError = createExportWrapper("clearLastError", 0);
  Module["_isVMReady"] = _isVMReady = createExportWrapper("isVMReady", 0);
  Module["_resetVMState"] = _resetVMState = createExportWrapper("resetVMState", 0);
  Module["_getVMStackSize"] = _getVMStackSize = createExportWrapper("getVMStackSize", 0);
  Module["_getVMFrameCount"] = _getVMFrameCount = createExportWrapper("getVMFrameCount", 0);
  Module["_getVMModuleCount"] = _getVMModuleCount = createExportWrapper("getVMModuleCount", 0);
